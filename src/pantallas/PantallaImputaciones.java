 ...
 * @author maquina0
 */
public class PantallaImputaciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        consultarGeneral = new javax.swing.JButton();
        ...
        tablaImputaciones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cliente", "Vendedor", "Recibo N°", "Fecha Recibo", "Importe Recibo", "Factura N°", "Fecha Emis Fact", "Importe Factura", "Movimiento", "Monto Movimiento", "Dif FAC REC"
            }
        ));
        ...
        consultarGeneral.setText("Consultar Imputaciones Generales");
        consultarGeneral.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                consultarGeneralActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(consultarGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelActionPerformed
        if (!imputaciones.isEmpty()) {
            try {
                ...
                expertoCrearExcel.crearExcel(imputaciones, fechaDesde, fechaHasta);
    ...
    private void consultarGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarGeneralActionPerformed
    ...
    }//GEN-LAST:event_consultarGeneralActionPerformed
    ...
    private javax.swing.JButton consultarGeneral;
    ...
    private void cargarImputacionesVendedor(String codVendedor, String fechaDesde, String fechaHasta) {
        imputaciones = expertoImputacion.obtenerImputacionesMovimientoVendedor(codVendedor, fechaDesde, fechaHasta);
        cargarTabla(imputaciones);
    }

    private void cargarImputaciones(String fechaDesde, String fechaHasta) {
        imputaciones = expertoImputacion.obtenerImputacionesMovimiento(fechaDesde, fechaHasta);
        cargarTabla(imputaciones);
    }

    private void cargarTabla(List<DtoImputacionMovimiento> imputacions) {
        ...
        defaultTableModel.addColumn("Movimiento");
        defaultTableModel.addColumn("Monto Movimiento");
        defaultTableModel.addColumn("Dif FAC REC");
        for (DtoImputacionMovimiento imputacion : imputacions) {
            ...
            fila[8] = imputacion.getMonvimiento();
            fila[9] = imputacion.getMontoMovimiento();
            fila[10] = imputacion.getDiferenciaFacRec();
